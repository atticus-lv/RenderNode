...
class RenderNodeSetProperty(RenderNodeBase):
    """A simple input node"""
    bl_idname = 'RenderNodeSetProperty'
...
def register():
    bpy.utils.register_class(RenderNodeSetProperty)


def unregister():
    bpy.utils.unregister_class(RenderNodeSetProperty)
